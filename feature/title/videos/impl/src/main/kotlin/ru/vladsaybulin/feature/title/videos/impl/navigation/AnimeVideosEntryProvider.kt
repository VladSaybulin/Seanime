...
package ru.vladsaybulin.feature.title.videos.impl.navigation
...
fun EntryProviderScope<SeanimeNavKey>.animeVideosEntry() = entry<AnimeVideosNavKey> { key ->
    val viewModel = hiltViewModel<AnimeVideosViewModel, AnimeVideosViewModel.Factory> {
        it.create(key)
    }
