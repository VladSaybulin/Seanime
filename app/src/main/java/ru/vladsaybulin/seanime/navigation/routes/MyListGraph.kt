...
import ru.vladsaybulin.feature.list.navigation.ListScreenRouteSerializer
...
object MyListGraph {
    ...
    @Serializable(ListScreen.Serializer::class)
    data class ListScreen(override val args: ListArgs) : ListScreenRoute {
        companion object Serializer : ListScreenRouteSerializer<ListScreen>()
    }
